...
func _process(delta: float) -> void:
	if Input.is_action_just_pressed("Dialogue") and textline == 1:
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("hmm... I'd be screaming out into the dark forest of space.")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$CalihanSpeech.play()

	if Input.is_action_just_pressed("Dialogue") and textline == 2:
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("Screw it.")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$CalihanSpeech.play()

	if Input.is_action_just_pressed("Dialogue") and textline == 3:
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("Ship, begin long range signal scan with search parameters 'Brimpie Orbital.'")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$CalihanSpeech.play()
	...
	if Input.is_action_just_pressed("Dialogue") and textline == 4:
		...
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("Running Scan...")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$ShipAISpeech.play()

	if Input.is_action_just_pressed("Dialogue") and textline == 5:
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("1 contact found")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$ShipAISpeech.play()
	...
	if Input.is_action_just_pressed("Dialogue") and textline == 6:
		...
		$TextboxContainer/MarginContainer/HBoxContainer/Label.set_text("Plot course to Brimpie Orbital and begin docking.")
		$TextboxContainer/TweenAnimation.play("TextTween")
		$CalihanSpeech.play()
