...
@onready var text: PackedScene = preload("res://Scenes/User Interface/Dialogue/Loop3DialogueBox.tscn")
...
func _process(delta: float) -> void:
	if Globals.HallwayLoop == 4:
		get_tree().change_scene_to_file("res://Scenes/Levels/DreamCutscene2.tscn")
